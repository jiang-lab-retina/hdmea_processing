...
through the unified pipeline (11 steps, excluding electrode alignment).
...
Usage:
    python batch_all_steps_dsgc_refine.py
    
    # Process specific range:
    python batch_all_steps_dsgc_refine.py --start 0 --end 10
    
    # Force overwrite existing files:
    python batch_all_steps_dsgc_refine.py --overwrite
"""
...
def process_single_recording(
    ...
    """
    Process a single recording through all 12 steps.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Batch process CMCR/CMTR files through 11 pipeline steps (no electrode alignment)"
    )
    parser.add_argument(
    ...
    print("=" * 70)
    print("Batch Processing: All Pipeline Steps (1-11, no electrode alignment)")
    print("=" * 70)

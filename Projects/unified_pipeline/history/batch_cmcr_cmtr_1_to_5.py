#!/usr/bin/env python
"""
Batch Processing: CMCR/CMTR Steps 1-5

Processes all matched CMTR/CMCR pairs from the CSV mapping file
through pipeline steps 1-5 (the steps that require raw file access).
...
Output files can then be processed through steps 6-11 without
needing access to the original CMCR/CMTR files.

Usage:
    python batch_cmcr_cmtr_1_to_5.py
    
    # Process specific range:
    python batch_cmcr_cmtr_1_to_5.py --start 0 --end 10
    
    # Force overwrite existing files:
    python batch_cmcr_cmtr_1_to_5.py --overwrite
"""
...
OUTPUT_DIR = Path(__file__).parent / "export_cmcr_cmtr_1_to_5"
...
def process_single_recording(
    ...
    """
    Process a single recording through steps 1-5.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Batch process CMCR/CMTR files through steps 1-5"
    )
    parser.add_argument(
    ...
    print("=" * 70)
    print("Batch Processing: CMCR/CMTR Steps 1-5")
    print("=" * 70)
